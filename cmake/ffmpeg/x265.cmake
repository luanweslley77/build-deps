...
ExternalProject_Add(x265-8bit
  ...
  PATCH_COMMAND ${CMAKE_COMMAND} -E make_directory ${X265_8BIT_DIR}
            COMMAND ${CMAKE_COMMAND} -E create_symlink ${X265_10BIT_DIR}/libx265.a ${X265_8BIT_DIR}/libx265_main10.a
...
add_custom_target(x265-multilib-combine ALL
  DEPENDS x265-8bit
  COMMAND /bin/sh -c "if [ ! -f ${X265_8BIT_DIR}/libx265_main.a ]; then cp ${X265_8BIT_DIR}/libx265.a ${X265_8BIT_DIR}/libx265_main.a; fi"
  COMMAND /bin/sh -c "ar -M < ${CMAKE_CURRENT_SOURCE_DIR}/cmake/ffmpeg/x265-multilib.ar" WORKING_DIRECTORY ${X265_8BIT_DIR}
  ...
  COMMAND ${CMAKE_COMMAND} -E copy ${X265_8BIT_DIR}/x265_config.h ${FFMPEG_INSTALL_PREFIX}/include/x265_config.h
